...
const insights = [
  ...
  },
  {
    ...
    content:content: "当前行业对女性向用户的理解存在系统性偏差——大量产品仍由男性决策者定义'女性想要什么'。但真实的女性用户需求远比'甜宠陪伴'复杂：她们追求角色人格的逻辑自洽性而非外貌，偏好仿真社交界面（聊天、朋友圈、语音、转账）营造的真实感而非传统对话框，对世界观可延展性的关注远超对新角色数量的需求。能够让女性用户参与内容设计决策的团队，才能做出真正有粘性的产品。"
  },
  {
