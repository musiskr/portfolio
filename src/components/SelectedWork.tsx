...
const works = [
  {
    ...
    problem: "2024 年中国女性向游戏市场规模达 80 亿元（+124.1%），2025 年女性玩家占比升至 48%。但 TOP10 收入占 TOP20 的 90% 以上，《恋与深空》一款产品拿走全赛道近半收入（约 24 亿元 / 47%）。所有人在优化同一个答案：更逼真的陪伴、更精致的卡面、更高的好感度天花板。没人在问新问题——如果女性玩家想要的不是被爱，而是被认真对待呢？",
